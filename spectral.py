...
# Load the predicted clusters from the CSV file
predicted_clusters = pd.read_csv('predicted_clusters.csv')

# Compute F1 score
f1 = f1_score(ground_truth['cluster_id'], predicted_clusters['cluster_id'], average='macro')

# Compute NMI
nmi = normalized_mutual_info_score(ground_truth['cluster_id'], predicted_clusters['cluster_id'])
